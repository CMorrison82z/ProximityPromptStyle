...
do
	...
	highlighter.FillColor = Color3.new(0,1,1)
	highlighter.FillTransparency = 1
	highlighter.OutlineTransparency = 1
	highlighter.Parent = promptUI
	
	table.insert(tweensForFadeOut, TweenService:Create(highlighter, tweenInfoQuick, { 
		FillTransparency = 1,
		OutlineTransparency = 1}))
	table.insert(tweensForFadeIn, TweenService:Create(highlighter, tweenInfoQuick, { 
...
function rbxClassic:Show(prompt, inputType, gui)
	...
	promptUI.Highlight.Adornee = prompt.Parent
...
function rbxClassic:Hide()
	...
	promptUI.Highlight.Adornee = nil
